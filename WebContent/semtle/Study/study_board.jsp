  ...
  <body>
    ...
    <section class="noticeboard">
      <div class="studyroom-head">
        <a href="${pageContext.request.contextPath}/semtle/Study/study_board_text.jsp?title=스터디룸"><span>글쓰기</span></a>
      </div>
      <div class="noticeboard-box">
        <a href="${pageContext.request.contextPath}/semtle/Study/study_board_room.jsp?title=스터디룸">
