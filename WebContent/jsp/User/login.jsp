...
<body>
	...
	<a href="${pageContext.request.contextPath}/jsp/index.jsp"><section class="home" id="login-home">
			<div class="home-main">
				<img src="${pageContext.request.contextPath}/jsp/images/login.PNG" alt="" />
				<h3>셈틀쟁이</h3>
			</div>
		</section></a>
	...
	<section class="login">
		<div class="login-box">
			<form action="userPro.jsp" id="loginform" method="post">
			<input type="hidden" name="type" value="login">
				...
				<div class="signupform">
					<a href="${pageContext.request.contextPath}/jsp/User/signup.jsp">Sign Up</a>
				</div>
			</form>
		</div>
	</section>
