...
<html lang="en">
  ...
  <body>
   <jsp:include page="${pageContext.request.contextPath}/jsp/header.jsp"></jsp:include>
      ...
      <form action="#" class="joinform">
        <table align="center">
          <tr>
            ...
            <td class="inputbox"><span><%=user.getUserId() %></span></td>
          </tr>

          <tr>
            <td align="center"><label class="info_must">*</label><label>학번</label></td>
            <td class="inputbox"><input type="number" name="studentid" /></td>
          </tr>
